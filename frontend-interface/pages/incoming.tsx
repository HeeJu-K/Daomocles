...
export default function Home() {
  ...
  const [editState, setEditState] = useState(
    Array.from({ length: tmpData.length }, () => false)
  );
  ...
  const handleDummy = (e) => {
    console.log(
      "new table test",
      document.getElementById("name0") as HTMLInputElement
    );
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <Navbar daoname={daoname} daoaccess={daoaccess} />
          ...
          <div className={styles.incomingoutgoing}>
            ...
            <p className="mt-4 w-full flex flex-grow items-center justify-between">
              <div>
                Month &nbsp;
                <select
                  className="px-3 py-1 border border-black rounded-xl text-black"
                  name="Months"
                  id="months"
                >
